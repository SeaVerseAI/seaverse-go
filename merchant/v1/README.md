# merchant - SeaVerse Go SDK

Merchant APIs for token verification and service integration
...
```bash
go get github.com/SeaVerseAI/seaverse-go/merchant/v1@latest
```
...
import (
    ...
    merchant "github.com/SeaVerseAI/seaverse-go/merchant/v1"
)
